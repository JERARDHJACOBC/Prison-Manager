...
<%
String sysdate = new java.sql.Date(System.currentTimeMillis()).toString();
%>
<HEAD>
...
<BODY class=SC>
    <BR><BR>
<h3 align=center>Today's IN-OUT Report</h3>
...
<%
	...
	try{
			...
			String Query = "Select * from inoutregister where OutTime like '%"+sysdate+"%' or InTime like '%"+sysdate+"%'";
