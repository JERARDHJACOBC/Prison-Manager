...
<H3 align=center>Delete Staff Member</H3>
<%
...
<FORM Name='DelForm' METHOD=POST ACTION="">
		...
		<TABLE align=center width="25%" bordercolor=#D8D8D8 border=1>
                        <TR>
				<TH class='row_title' colspan=2>Delete Staff Member</TH>
                        </TR>
		<TR>
...
<%
	try{
			...
			if(Condition.trim().equalsIgnoreCase("undefined")){
				...
				Query1 = "Select * from staffdetails";
			}
			else{
				System.out.println("in else");
				Query1 = "Select "+Condition+" from staffdetails group by "+Condition;
			}
			String str="";
...
<%
	...
	try{
			...
			String Query = "Delete from staffdetails where Name='"+Value+"'";
