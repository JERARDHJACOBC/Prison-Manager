	...
	try{
			...
			%>
						<table class=notebook border=1>
							<tr class=row_title>
							<th class=row_title>paroleid</th><th class=row_title>PrisonerId</th><th class=row_title>StaffId</th><th class=row_title>RequestDate</th><th class=row_title>Reason</th><th class=row_title>Status</th><th class=row_title>ApprovalDate</th><th class=row_title>From</th><th class=row_title>To</th><th class=row_title>Validated By</th>
							</tr>
					<%
			int rCount=0;
			while(rs.next())
