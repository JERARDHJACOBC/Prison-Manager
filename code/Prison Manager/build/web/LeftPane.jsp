<%@ page import="java.util.*,javax.mail.*, javax.mail.internet.*,java.sql.*,com.PrisonManager.GetMenuItems" %>
<%@ page language="java" %>
<%@ page session="true" %>
...
<html>
    ...
    <HEAD>
        ...
        <script language=javascript>
                ...
                function fnToggleStyle(obj){
                  /*  if(obj){
                            obj.style.className="HighLight";
                    }else{
                            obj.style.className="subMenu";
                    }*/
                    var menuName=obj.id;
                    <%
                     for(i=0;i<iCnt;i++)
    ...
    <BODY class="Main" onload='fnInitiate()'>
        <BR><BR>
                    ...
                    if(vsTemp.isEmpty()==false){
                          ...
                          int siCnt = Integer.parseInt(sICnt);
                           ...
                           for(int j=0;j<siCnt;j++)
                             {
                                    %><BR><BR> &nbsp; &nbsp; <a href="<%=sexecutable[j] %>" target="<%=stargetFrame[j]%>"  class="subMenu" onclick="fnToggleSubMenuStyle(this,'<%=sICnt%>','<%=j%>')" id="<%=slabel[j]%>">&nbsp;-&gt;&nbsp;<%=slabel[j]%></a></LI><%
