...
<%
	...
	try{
			...
			String Query = "Select * from staffdetails order by `staffid`";
			rs = stmt.executeQuery(Query);
			%>
						<table class=notebook border=1>
							<tr class=row_title>
							<th class=row_title>StaffId</th><th class=row_title>Name</th><th class=row_title>Age</th><th class=row_title>Designation</th><th class=row_title>DateOfJoining</th><th class=row_title>Address</th><th class=row_title>Salary</th><th class=row_title>LocationId</th>
							</tr>
					<%
			int rCount=0;
			while(rs.next())
