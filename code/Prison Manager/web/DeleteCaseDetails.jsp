...
<%
	try{
			...
			if(Condition.trim().equalsIgnoreCase("undefined")){
				...
				Query1 = "Select * from casedetails";
			}
			else{
				System.out.println("in else");
				Query1 = "Select "+Condition+" from casedetails group by "+Condition;
			}
			String str="";
...
<%
	...
	ResultSet rs=null;
	Statement stmt=null;
	String Value = request.getParameter("CaseId");
	try{
			con = com.PrisonManager.ConnectionPool.getConnection();
			stmt =  con.createStatement();
	
			
			String Query = "Delete from casedetails where CaseId='"+Value+"'";
