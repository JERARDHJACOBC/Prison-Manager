...
<BODY class=SC>
<h2 align=center>View Prisoners</h2>
...
<%
	...
	try{
			...
			String Query = "Select * from prisoners order by `prisonerid`";
			rs = stmt.executeQuery(Query);
			%>
						<table class=notebook border=1>
							<tr class=row_title>
							<th class=row_title>PrisonerId</th><th class=row_title>Name</th><th class=row_title>Age</th><th class=row_title>caseid</th><th class=row_title>FromDate</th><th class=row_title>ToDate</th><th class=row_title>Mode</th><th class=row_title>Address</th>
							</tr>
					<%
			int rCount=0;
			while(rs.next())
