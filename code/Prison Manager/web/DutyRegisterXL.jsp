...
<BODY class=SC>
<h2 align=center>Duty Register</h2>
	...
	try{
			...
			%>
						<table class=notebook border=1>
							<tr class=row_title>
							<th class=row_title>DutyId</th><th class=row_title>StaffId</th><th class=row_title>DutyOn</th><th class=row_title>ShiftStartsAt</th><th class=row_title>ShiftEndsAt</th><th class=row_title>DutyAs</th>
							</tr>
					<%
			int rCount=0;
			while(rs.next())
